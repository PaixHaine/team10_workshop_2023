...
@section('content')
    ...
    <div class="form-group">
        <label for="nature">Type de contact</label>
    ...
    <table class="table">
        ...
        @foreach ($contacts as $contact)
            <tr>
                ...
                <td>{{ $contact->genre }}</td>
                <td>
                    <a href="{{ route('contacts.edit', ['id' => $contact->id]) }}" class="btn edit"><i class="fas fa-edit"></i>Modifier</a>
                    ...
                    <a class="ml-3" href="{{ route('contacts.show', ['id' => $contact->id]) }}"><i class="fas fa-eye viewContact"></i></a>
                </td>
            </tr>
        @endforeach
        </tbody>
